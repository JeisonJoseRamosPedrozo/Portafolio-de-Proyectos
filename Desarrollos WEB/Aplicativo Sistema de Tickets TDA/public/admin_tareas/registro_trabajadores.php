...
<html lang="en">
  ...
  <body>
    <div class="container fondo">
        <h1 class="text-center">Registro de Integrantes de TDA</h1>
        <br><br>
...
$(document).ready(function() {
  ...
  $.ajax({
    url: "registroUsers.php",
    method: "GET",
    dataType: "json",
    success: function(data) {
      var tabla = $("#datos_usuario tbody");
      $.each(data, function(index, element) {
        tabla.append("<tr><td> " + element.name + "</td><td>" + element.email + "</td><td>" + element.identificacion+ "</td></tr>");
      });
    },
