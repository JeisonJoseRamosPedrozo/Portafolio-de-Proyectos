...
if(isset($_POST['enviar'])){
    ...
    if ($resultado->num_rows > 0) {
        ...
        if ($resultado->num_rows > 0) {
            ...
            header('Location: terminado.php');
        }

    } else {
        // Mostrar mensaje de error y requerir registro
        echo '<div class="error-message">El correo electrónico o código de registro no existe.</div>'; 
...
<body>
    ...
    <br>
    <div class="registrar">
        <a href="registrarse.php" class="btn">Aún no me he registrado, quiero registrarme ahora</a>
    </div>
    </form>
