...
class filtrosCombustible : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_filtros_combustible)

        val img1 = findViewById<ImageView>(R.id.imgALG2421)
        val img2 = findViewById<ImageView>(R.id.imgALG7517)
        val img3 = findViewById<ImageView>(R.id.imgALG7634)
        val img4 = findViewById<ImageView>(R.id.imgALG200051)
        val img5 = findViewById<ImageView>(R.id.imgALG7605)
        val img6 = findViewById<ImageView>(R.id.imgALG7608)
        val img7 = findViewById<ImageView>(R.id.imgALG7587)
        val img8 = findViewById<ImageView>(R.id.imgALG7557)
    ...
    private fun producto1(nombreUsuario: String) {
        val nameProduct = "Filtro de Combustible ALG-2421"
        val type = "Filtro de Tipo Diesel"
    ...
    private fun producto2(nombreUsuario: String) {
        val nameProduct = "Filtro de Combustible ALG-7517"
        val type = "Filtro de Tipo Diesel"
    ...
    private fun producto3(nombreUsuario: String) {
        val nameProduct = "Filtro de Combustible ALG-7634"
        val type = "Filtro de Tipo Diesel"
    ...
    private fun producto4(nombreUsuario: String) {
        val nameProduct = "Filtro de Combustible ALG-20005/1"
        val type = "Filtro de Tipo Diesel"
    ...
    private fun producto5(nombreUsuario: String) {
        val nameProduct = "Filtro de Combustible ALG-7605"
        val type = "Filtro de Tipo Diesel"
    ...
    private fun producto6(nombreUsuario: String) {
        val nameProduct = "Filtro de Combustible ALG-7608"
        val type = "Filtro de Tipo Diesel"
    ...
    private fun producto7(nombreUsuario: String) {
        val nameProduct = "Filtro de Combustible ALG-7587"
        val type = "Filtro de Tipo Diesel"
    ...
    private fun producto8(nombreUsuario: String) {
        val nameProduct = "Filtro de Combustible ALG-7557"
        val type = "Filtro de Tipo Diesel"
