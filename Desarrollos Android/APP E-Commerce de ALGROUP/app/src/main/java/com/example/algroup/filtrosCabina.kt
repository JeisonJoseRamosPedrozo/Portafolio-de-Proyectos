...
class filtrosCabina : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_filtros_cabina)

        val img1 = findViewById<ImageView>(R.id.imgALC5140)
        val img2 = findViewById<ImageView>(R.id.imgALC5133)
        val img3 = findViewById<ImageView>(R.id.imgALC6361)
        val img4 = findViewById<ImageView>(R.id.imgALC5123)
        val img5 = findViewById<ImageView>(R.id.imgALC5122)
        val img6 = findViewById<ImageView>(R.id.imgALC6356)
        val img7 = findViewById<ImageView>(R.id.imgALC5106)
        val img8 = findViewById<ImageView>(R.id.imgALC5116)
    ...
    private fun producto1(nombreUsuario: String) {
        val nameProduct = "Filtro de Cabina ALC - 5140"
        val type = "Filtro de Tipo Polen De Cabina"
    ...
    private fun producto2(nombreUsuario: String) {
        val nameProduct = "Filtro de Cabina ALC - 5133"
        val type = "Filtro de Tipo Polen De Cabina"
    ...
    private fun producto3(nombreUsuario: String) {
        val nameProduct = "Filtro de Cabina ALC - 6361"
        val type = "Filtro de Tipo Cabina De Carbono"
    ...
    private fun producto4(nombreUsuario: String) {
        val nameProduct = "Filtro de Cabina ALC - 5123"
        val type = "Filtro de Tipo Polen De Cabina"
    ...
    private fun producto5(nombreUsuario: String) {
        val nameProduct = "Filtro de Cabina ALC - 5122"
        val type = "Filtro de Tipo Polen De Cabina"
    ...
    private fun producto6(nombreUsuario: String) {
        val nameProduct = "Filtro de Cabina ALC - 6356"
        val type = "Filtro de Tipo Cabina De Carbono"
    ...
    private fun producto7(nombreUsuario: String) {
        val nameProduct = "Filtro de Cabina ALC - 5106"
        val type = "Filtro de Tipo Polen De Cabina"
    ...
    private fun producto8(nombreUsuario: String) {
        val nameProduct = "Filtro de Cabina ALC - 5116"
        val type = "Filtro de Tipo Polen De Cabina"
